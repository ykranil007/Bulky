...
$(document).on('click', 'a[name="confirm_cancellation"]', function () {
    ...
    var item_id = $('input:checkbox[name=product_checkbox]').map(function() 
    {    
        if($(this).is(':checked'))
            return $(this).val();
    }).get();
    ...
    $.ajax({
        url     : 'cancel-product',
        type    : 'post',
        data    : {reason:reason_id,comment:comment_txt,item_id:item_id,master_order_id:master_order_id},
        dataType: 'json',
        success : function(json)
        {
...
$(document).on('click', 'a[name="confirm_return"]', function () {
    ...
    $.ajax({
        url     : 'return-product',
        type    : 'post',
        data    : {reason:reason_id,comment:comment_txt,item_id:item_id,order_id:order_id},
        dataType: 'json',
        success : function(json)
        {
