$(function($) {    
    ...
    function create_user_request()
    {
        ...
        $('input[id^="subtosub-"]:checked').each(function (){
            sub_tosub_category.push($(this).attr('url'));
        });
        if (sub_tosub_category.length === 0 && $('#sub_tosub_category').val()!='') {
            sub_tosub_category.push($('#sub_tosub_category').val());
        }
        ...
        $('input[id^="size-"]:checked').each(function (){ size.push($(this).attr('url'));});
