jQuery(function($) {
            ...
            {            
                ...
                { 
                   ...
                   if(json.total_product > 0)
                   {
                      ...
                      stop_loader(json.total_product,20,page_no);
    ...
    $(window).load(function() {
        ...
        if(get_parameter_by_name('keywords', query_string)!='' || get_parameter_by_name('keywords', query_string)!= null)
        {
            //cate_url = get_parameter_by_name('keywords', query_string);
            alert(get_parameter_by_name('keywords', query_string));
        }
        alert('keywords');
        ...
        if(slider.find('img').length < 1 || slider.find('img').length == 0)
        {
            alert('remove');
            //slider.remove();
        }
