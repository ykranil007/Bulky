...
class Hybrid_Endpoint
{
    ...
    public static function process($request = null)
    {
        ...
        if (isset(Hybrid_Endpoint::$request["get"]) && Hybrid_Endpoint::$request["get"] ==
            "openid_policy")
        {
    ...
    public static function processOpenidXRDS()
    {
        ...
        $output = str_replace("{RETURN_TO_URL}", str_replace(array(
            "<",
            ">",
            "\"",
            "'",
            ...
            "&quot;",
            "&apos;",
            "&amp;"), Hybrid_Auth::getCurrentUrl(false)), file_get_contents(dirname(__file__) .
            "/resources/openid_xrds.xml"));
        print $output;
        die();
    }
    ...
    {
        $output = str_replace("{X_XRDS_LOCATION}", htmlentities(Hybrid_Auth::
            getCurrentUrl(false), ENT_QUOTES, 'UTF-8') . "?get=openid_xrds&v=" . Hybrid_Auth::
            $version, file_get_contents(dirname(__file__) . "/resources/openid_realm.html"));
        print $output;
        die();
    }
    ...
    public static function processAuthStart()
    {
        ...
        catch (exception $e)
        {
            ...
            Hybrid_Error::setError($e->getMessage(), $e->getCode(), $e->getTraceAsString(),
                $e);
