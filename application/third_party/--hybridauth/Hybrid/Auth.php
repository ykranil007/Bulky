...
class Hybrid_Auth
{
    ...
    public static function initialize($config)
    {
        ...
        Hybrid_Logger::info("Hybrid_Auth::initialize(). Hybrid_Auth version: " .
            Hybrid_Auth::$version);
        Hybrid_Logger::info("Hybrid_Auth::initialize(). Hybrid_Auth called from: " .
        ...
        Hybrid_Logger::debug("Hybrid_Auth initialize. dump current session: ",
            Hybrid_Auth::storage()->getSessionData());
    ...
    public static function setup($providerId, $params = null)
    {
        ...
        if (!$params)
        {
            ...
            Hybrid_Logger::debug("Hybrid_Auth::setup( $providerId ), no params given. Trying to get the stored for this provider.",
                $params);
        }
        if (!$params)
        {
        ...
        if (is_array($params) && !isset($params["hauth_return_to"]))
        {
            ...
            Hybrid_Logger::debug("Hybrid_Auth::setup( $providerId ). HybridAuth Callback URL set to: ",
    ...
    public static function redirect($url, $mode = "PHP")
    {
        ...
        if ((PHP_VERSION_ID >= 50400 && PHP_SESSION_ACTIVE === session_status()) || (PHP_VERSION_ID <
            50400 && isset($_SESSION) && session_id()))
        {
            session_write_close();
        }
        if ($mode == "PHP")
