                ...
                <?php $delivery_id = 0; foreach($delvry_ads as $user) {  $delivery_id = $user->delivery_id;?>                    
                    ...
                    <div id="add_address">
                        ...
                        <form action="add_delvry_ads" method="post">                            
                            ...
                            <p>
                            <label>Pincode</label>
                            <input type="text" name="pincode" id="pincodee" maxlength="6" minlength="6" required>
                            </p>
                            <p>
                            <label>Address</label>
                        ...
                        <div class="form-horizontal">
                             <form action="<?php echo base_url('update-ads').'/'.make_encrypt($edit->delivery_id);?>" method="post">
                                <div class="form-group">
                                    <label>Name</label>
                                    <div class="col-value"><input type="text" name="name" value="<?php echo $edit->name; ?>" required></div>
                                </div>
                                <div class="form-group">
                                    <label>Pincode</label>
                                    <div class="col-value"><input type="text" name="pincode" value="<?php echo $edit->pincode; ?>" maxlength="6" minlength="6" required></div>
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                    <div class="col-value"><textarea rows="3" name="address" minlength="15" required><?php echo $edit->address; ?></textarea></div>
                                </div>
                                <div class="form-group">
                                    <label>City</label>
                                    <div class="col-value"><input type="text" name="city" value="<?php echo $edit->city; ?>" required></div>
                                </div>
                                <div class="form-group">
                                    <label>State</label>
                                    <div class="col-value"><input type="text" name="state" value="<?php echo $edit->state; ?>" required></div>
                                ...
                                <div class="form-group">
                                <label>Mobile</label>
                                    <div class="col-value"><input type="tel" name="mobile" id="delivery_mobile" maxlength="10" minlength="10" value="<?php echo $edit->mobile; ?>" required></div>
                                </div>
                                <div class="form-group">
                                <label>Landmark</label>
                    ...
                    <?php } else if(empty($delvry_ads)) { ?>
                        ...
                        <div class="form-horizontal">
                             <form action="add_delvry_ads" method="post">
                                ...
                                <div class="form-group">
                                    <label>Pincode</label>
                                    <div class="col-value"><input type="text" name="pincode" id="pincodee" maxlength="6" minlength="6" required></div>
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Item">
                                        <div class="detail">                                            
                                            ...
                                            <?php if(!empty($cartitem->size_name)) { ?>
                                            <p>Size: <?php echo ucfirst($cartitem->size_name);?></p>
                                            <?php } ?>
                                        </div>
                                    </td>
                                    <td data-label="Qty">
                                    ...
                                    <td data-label="Price">
                                        <p class="standard-price offer-save">&#8377; <?php echo $cartitem->price; ?></p>
                    	...
                    	<div class="cart_item_summary">
                            <div class="wbox">
                                <dl>
                                    <dt>Sub Total:</dt>
                                    <dd id="sub_total"></dd>
                                    <div id="total_tax_val" style="display: none;">
                                        <dt>Total Taxes:</dt>
                                        <dd id="total_tax"></dd>
                                    </div>
                                    <dt>Delivery Charges:</dt>
                                    <input type="hidden" id="delivery_charge" value="">
                                    <dd id="show_delivery_charge"></dd>
                                    <div id="voucher_total" style="display: none;">
                                        <dt>Voucher Discount:</dt>
                                        <dd id="voucher_value"></dd>
                                    </div>
                                    <dt>Rounded Off</dt>
                                    <dd id="round_off"></dd>
                                    <dt>Amount Payable:</dt>
                                    <dd id="pro_final_price"></dd>
                                </dl>
