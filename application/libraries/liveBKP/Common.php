...
class Common 
{
    ...
    public function get_charges_for_delhivery($product_ids,$delivery_id,$qty)
    {
        ...
        $zone   = $this->create_order_zone_by_product_id($product_ids,$delivery_id);
    ...
    public function get_order_weight($product_ids,$qty)
    {
        ...
        'tblblk_product_additional_info',"product_id IN($product_ids)");
        $order_weight = ($order_weight_info->order_weight / 5000) * 1000;        
        return (($order_weight > $order_weight_info->package_weight)?$order_weight:$order_weight_info->package_weight * 1000) * $qty; // As per Surface of Delhivery
    }
    
    public function create_order_zone_by_product_id($product_ids,$delivery_id)
    {
        ...
        $where = "pincode = '302022'"; //".$seller_pincode->pickup_pincode."  // Bulknmore warehouse pincode
